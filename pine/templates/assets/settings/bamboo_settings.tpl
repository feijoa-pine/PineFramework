...
class BambooSettings
{
    ...
    const   TIMESTAMP_PRECISION_DEFINITION = "";    //"(".self::TIMESTAMP_PRECISION.")";
    ...
    private static $requireLgDel = array(
        self::LG_DEL => array(
            "type" => "TINYINT", "collate" => self::COLLATE, "attribute" => null, "null" => false,
            "default" => 0, "other" => null, "comment" => "論理削除",
